...
const facts = [
  ...
  { label: "رأس المال المدفوع", value: "3,500,000 جنيه" },
  { label: "رأس المال المرخص", value: "15,000,000 جنيه" },
  { label: "الأصناف المسجلة", value: "23 صنفاً" },
];
    ...
    <div dir="rtl" lang="ar">
      ...
      <Container className="grid gap-14 py-14 sm:py-16 lg:grid-cols-[1.3fr_1fr]">
        <div className="space-y-4 text-[0.95rem] leading-loose text-ink-soft">
          ...
          <p>
            برأس مال مدفوع وقدره ثلاثة ملايين وخمسمائة ألف جنيه مصرى، ورأس مال
            مرخص به وقدره خمسة عشر مليون جنيه مصرى.
          </p>
          <p>
            بدأت الشركة فى تسجيل الأدوية والمستحضرات البيطرية الخاصة بصناعة
            الدواجن والثروة الحيوانية، حتى وصلت الأصناف إلى 23 صنفاً منتقاة
